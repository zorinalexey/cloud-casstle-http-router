...
class Router
{
    ...
    {
        if (!self::$instance instanceof \CloudCastle\Http\Router\Router) {
    ...
    {
        if ($this->cache instanceof \CloudCastle\Http\Router\RouteCache) {
    ...
    public function compile(bool $force = false): bool
    {
        ...
        if (!$this->compiler instanceof \CloudCastle\Http\Router\RouteCompiler) {
            $this->compiler = new RouteCompiler();
        }
    ...
    {
        if (!$this->cache instanceof \CloudCastle\Http\Router\RouteCache || $this->cacheLoaded) {
            return false;
        }
