...
Helper Functions - это глобальные PHP функции, которые упрощают работу с routeurом, предоставляя короткий и удобный API без необходимости использовать полные имена классов.
...
**Описание:** Получить статистику routeurа.
...
**Описание:** Получить все routes с указанным тегом.
