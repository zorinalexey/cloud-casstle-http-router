...
[**English**](07_NAMED_ROUTES.md) | [Русский](../../ru/features/07_NAMED_ROUTES.md) | [Deutsch](../../de/features/07_NAMED_ROUTES.md) | [Français](../../fr/features/07_NAMED_ROUTES.md) | [中文](../../zh/features/07_NAMED_ROUTES.md)
...
- [URL Generation](12_URL_GENERATION.md) - Generate URLs from named routes
- [Helper Functions](09_HELPER_FUNCTIONS.md) - route() helper function
- [API Reference](../API_REFERENCE.md) - Complete API reference

---

© 2024 CloudCastle HTTP Router  
[⬆ Back to top](#named-routes)