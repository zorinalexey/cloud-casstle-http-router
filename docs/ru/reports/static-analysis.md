# Отчет по статическим анализаторам (сводный)
...
**Переводы**: [English](../../en/reports/static-analysis.md) | [Deutsch](../../de/reports/static-analysis.md) | [Français](../../fr/reports/static-analysis.md)
...
- **[PHPStan](static-analysis-phpstan.md)** - анализ типов (level max)
- **[PHPCS](static-analysis-phpcs.md)** - стандарты кодирования (PSR-12)
- **[PHPMD](static-analysis-phpmd.md)** - качество кода (mess detection)
